...
import 'package:movie_tix/pages/history.dart';
import 'package:movie_tix/pages/homePage.dart';
...
class _MainPageState extends State<MainPage> {
   ...
   String searchValue = '';
  final List<String> _suggestions = ['Your Name', 'Spirited Away', 'Avanger', 'SpiderMan',];
